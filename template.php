 ...
 */
function hippelicious_preprocess_page(&$vars) {
  include_once(drupal_get_path('theme', 'hippelicious') .'/styles.inc');
  $vars['styles'] .= hippelicious_style_css(hippelicious_get_style_info());
  $vars['styles_ie6'] = hippelicious_style_ie6();
 ...
 */
function hippelicious_style_css($info) {
 ...
 */
function hippelicious_style_ie6() {
